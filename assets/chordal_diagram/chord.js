var width_in = $(window).width()
var height_in = $(window).height()
console.log(width_in)
console.log(height_in)

/*** Define parameters and tools ***/
var width = width_in * 0.8,
    height = height_in * 0.8,
    outerRadius = Math.min(width, height) / 2 - 120,//100,
    innerRadius = outerRadius - 10;

var dataset = "assets/chordal_diagram/topics/Atmosphere.json";
...
d3.csv("assets/chordal_diagram/regionsfish.csv", function(error, regionData) {
...
d3.select("#Atmosphere").on("click", function () {
    updateChords( "assets/chordal_diagram/topics/Atmosphere.json" );
...
d3.select("#Cleanliness").on("click", function() {
    updateChords( "assets/chordal_diagram/topics/Cleanliness.json" );
   // disableButton(this);
});

d3.select("#Couple").on("click", function() {
    updateChords( "assets/chordal_diagram/topics/Couple.json" );
    //disableButton(this);
});

d3.select("#Family").on("click", function() {
    updateChords( "assets/chordal_diagram/topics/Family.json" );
    //disableButton(this);
});

d3.select("#Food_Quality").on("click", function() {
    updateChords( "assets/chordal_diagram/topics/Food_Quality.json" );
    //disableButton(this);
});

d3.select("#Live_Music").on("click", function() {
    updateChords( "assets/chordal_diagram/topics/Live_Music.json" );
    //disableButton(this);
});

d3.select("#Opening_Hours").on("click", function() {
    updateChords( "assets/chordal_diagram/topics/Opening_Hours.json" );
    //disableButton(this);
});

d3.select("#Parking").on("click", function() {
    updateChords( "assets/chordal_diagram/topics/Parking.json" );
    //disableButton(this);
});

d3.select("#Price").on("click", function() {
    updateChords( "assets/chordal_diagram/topics/Price.json" );
    //disableButton(this);
});

d3.select("#Public_Transportation").on("click", function() {
    updateChords( "assets/chordal_diagram/topics/Public_Transportation.json" );
    //disableButton(this);
});

d3.select("#Staff").on("click", function() {
    updateChords( "assets/chordal_diagram/topics/Staff.json" );
    //disableButton(this);
});

d3.select("#Wait_Times").on("click", function() {
    updateChords( "assets/chordal_diagram/topics/Wait_Times.json" );
    //disableButton(this);
});
